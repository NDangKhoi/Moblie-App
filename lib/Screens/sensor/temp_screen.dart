...
import 'package:flutter_application_2/Semi/temp_semichart.dart';

import '../../Services/Limit/temp.dart';
...
class _TempScreenState extends State<TempScreen> {
  ...
  void _dataSensor() {
    _streamBuilde =
        _sensorDataRTDB.child('SetValue/Temp').onValue.listen((event) {
      Map<String, dynamic> data =
          Map<String, dynamic>.from(event.snapshot.value as Map);
      final limitData = TempLimit.formRTDB(data);
      setState(() {
      ...
      body: SafeArea(
        ...
        child: Column(
            ...
            children: [
              ...
              const Expanded(child: TempSemiChart()),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
