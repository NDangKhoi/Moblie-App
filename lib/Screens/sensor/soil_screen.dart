...
import 'package:flutter_application_2/Semi/soil_semichart.dart';

import '../../Services/Limit/soil.dart';
...
class _SoilScreenState extends State<SoilScreen> {
  ...
  void _dataSensor() {
    _streamBuilde =
        _sensorDataRTDB.child('SetValue/Soil').onValue.listen((event) {
      Map<String, dynamic> data =
          Map<String, dynamic>.from(event.snapshot.value as Map);
      final limitData = SoilLimit.formRTDB(data);
      setState(() {
      ...
      body: SafeArea(
        ...
        child: Column(
            ...
            children: [
              ...
              const Expanded(child: SoilSemiChart()),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
